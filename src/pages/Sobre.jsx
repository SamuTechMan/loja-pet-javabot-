    ...
    <div className="flex h-screen flex-col items-center justify-center bg-zinc-900">
      <div className="relative flex w-full flex-1 flex-col items-center justify-center gap-12">
        ...
        <p className="max-w-3xl p-6 text-justify text-lg text-emerald-100">
          ...
          desenvolvimento está empenhada em fornecer a melhor experiência
          possível para os nossos usuários. O Pet JavaBot é um projeto de código
          aberto e estamos sempre abertos a contribuições da comunidade. Também
          e possível você adquirir um pet na nossa loja que está em constante
          mudança na variação.
        </p>
      </div>
