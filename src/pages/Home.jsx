...
export default function Home() {
  ...
  return (
    <div class="flex flex-1 flex-col items-center justify-center bg-zinc-900">
      <div class="relative flex w-full flex-1 flex-col items-center justify-center gap-12">
        <button
          onClick={() => {
            setVisible(!visible);
          }}
          class="rounded-xl border-2 border-emerald-400 shadow-md shadow-emerald-100 transition-all hover:scale-110 hover:shadow-lg hover:shadow-emerald-600"
        >
          <img
            id="middle-image"
        ...
        <div class="text-center text-2xl text-emerald-300">Javabogus</div>
        {visible && (
          <>
            {" "}
            <img
              class="absolute bottom-10 right-10 w-36"
            ...
            />
            <img
              class="absolute top-10 left-10 w-36"
              src="https://i.kym-cdn.com/photos/images/original/002/018/144/1f8.png"
              alt=""
            />
            <img
              class="absolute top-10 right-10 w-48"
            ...
            />
            <img
              class="absolute bottom-0 left-1/2 w-48 -translate-x-1/2"
            ...
            />
            <img
              class="absolute top-0 left-1/2 w-48 -translate-x-1/2"
